...
.put(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
    Dishes.findById(req.params.dishId)
    .then((dish) => {
        commentToUpdate = dish.comments.id(req.params.commentId);
        if (dish != null && commentToUpdate != null) {
...
.delete(cors.corsWithOptions, authenticate.verifyUser, (req, res, next) => {
    Dishes.findById(req.params.dishId)
    .then((dish) => {
        commentToDelete = dish.comments.id(req.params.commentId);
        if (dish != null && commentToDelete != null) {
